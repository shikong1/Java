...
List<User> findALL();
    ...
    List<User> list();
//*insert*/
@Insert("INSERT INTO t_user(USER_ID,USERNAME,PASSWORD,PHONE_NUM) VALUES(#{userId},#{username},#{password},#{mobileNum})")
@Options(useGeneratedKeys = true,keyProperty = "id",keyColumn = "id")
int insertByUser(User user);
/*gen ju phnum cha zhao*/
    User findUserByPhone(@Param("mobileNum") String mobileNum);
/*update*/


    @Update("update t_user set USER_ID=#{userId},USERNAME=#{username},PASSWORD=#{password} WHERE PHONE_NUM = #{mobileNum}")
